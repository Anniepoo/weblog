...
:- use_module(library(wl/info/map/google_map)).
:- use_module(library(wl/info/map/leaflet_map)).
...
the map.  The final argument may be
  ...
  * id(-ID) The map div id and javascript variable name will be set to
  this. default `leaflet_map` or `google_map` depending on the provider.
  Must be valid JavaScript identifier as atom.
